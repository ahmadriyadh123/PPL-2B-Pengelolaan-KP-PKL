...
/**
 * BUG-011 — Unit test untuk DateUtil (participant-service).
...
class DateUtilTest {
    ...
    void stringToDate_randomString_returnsNull() {
        Date result = DateUtil.stringToDate("bukan/tanggal/valid");
    ...
    @Test
    @DisplayName("checkNowDate() - rentang valid yang mencakup 'sekarang' harus mengembalikan true")
    ...
    @Test
    @DisplayName("checkNowDate() - rentang valid yang sudah lewat harus mengembalikan false")
