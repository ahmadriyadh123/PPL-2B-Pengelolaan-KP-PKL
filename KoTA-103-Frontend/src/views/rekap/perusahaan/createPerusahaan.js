...
const CreatePerusahaan = () => {
  ...
  useEffect(() => {
    ...
    const getPic = async () => {
      axios.defaults.withCredentials = true
      await axios
        .get(`${process.env.REACT_APP_API_GATEWAY_URL}account/get-committee`, {
  ...
  const onFinish = async (index) => {
    enterLoading(index)
    await axios
      .post(`${process.env.REACT_APP_API_GATEWAY_URL}company/create`, {
            ...
            <CCol sm={12}>
              ...
              >
                ...
                <Form.Item name="PIC">
                  ...
                  >
                    {pic.map((item, i) => (
                      <Select.Option key={i} value={item.id_lecturer}>
                        {item.name}
                      </Select.Option>
                    ))}
                  </Select>
                ...
                <Form.Item name="websitePerusahaan">
                  <Input
                    onChange={(e) => {
                      setData((pre) => {
                ...
                <Row>
                  ...
                  <Col span={12}>
                    <b>
                      Nomor Telepon Perusahaan<span style={{ color: 'red' }}> *</span>
                    </b>
                    <Form.Item
                      name="nohpPerusahaan"
                      rules={[
                ...
                <Row>
                  <Col span={12}>
                    ...
                    <Form.Item name="tahunPerusahaan" style={{ paddingRight: '20px' }}>
                      <DatePicker
                        picker="year"
                        style={{ width: '100%' }}
                ...
                <Row>
                  <Col span={8}>
                    ...
                    <Form.Item
                      name="emailCP"
                      rules={[
                        { required: true, message: 'Email narahubung tidak boleh kosong!' },
                  ...
                  <Col span={8}>
                    <b>
                      Nomor Narahubung<span style={{ color: 'red' }}> *</span>
                    </b>
                    <Form.Item
                      name="nomorCP"
                      rules={[
                        { required: true, message: 'Nomor telepon narahubung tidak boleh kosong!' },
                        {
                          required: true,
                          message: 'Format nomor narahubung hanya angka!',
                          pattern: /^\d+$/,
                        },
                      ]}
                      style={{ paddingRight: '20px' }}
                  ...
                  <Col span={8}>
                    ...
                    <Form.Item
                      name="jabatanCP"
                      rules={[
                        { required: true, message: 'Jabatan narahubung tidak boleh kosong!' },
                      ]}
                    >
                      <Input
                        onChange={(e) => {
