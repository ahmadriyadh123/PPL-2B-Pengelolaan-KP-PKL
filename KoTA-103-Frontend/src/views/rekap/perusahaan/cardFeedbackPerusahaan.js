...
const CardFeedbackPerusahaan = () => {
  ...
  useEffect(() => {
    ...
    const getFeedback = async () => {
      axios.defaults.withCredentials = true
      await axios
        .get(`${process.env.REACT_APP_API_GATEWAY_URL}company/feedback/get-by-company`, {
          ...
          <CCard className="mb-4" style={{ overflowX: 'scroll' }}>
            <CCardBody>
              <Row align="middle">
                ...
                <Col
                  span={
                    data.is_more_than_timeline_d3 === true || data.status_submit_d3 === 1 ? 19 : 16
                  }
                >
          ...
          <CCard className="mb-4" style={{ overflowX: 'scroll' }}>
            <CCardBody>
              <Row align="middle">
                ...
                <Col
                  span={
                    data.is_more_than_timeline_d4 === true || data.status_submit_d4 === 1 ? 19 : 16
                  }
                >
