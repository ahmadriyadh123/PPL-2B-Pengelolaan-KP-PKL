...
const EvaluasiPerusahaan = () => {
  ...
  useEffect(() => {
    ...
    const getEvaluasi = async () => {
      axios.defaults.withCredentials = true
      await axios
        .get(`${process.env.REACT_APP_API_GATEWAY_URL}company/evaluation/get-by-committee`, {
            ...
            <Col style={{ paddingLeft: '10px' }}>
              {(
                localStorage.getItem('id_prodi') === '0'
                  ? record.status_evaluated[0] === 1
                  : record.status_evaluated[parseInt(tab) - 1] === 1
              ) ? (
          ...
          <CRow>
            ...
            <CCol sm={6}>
              <CCard
                className="mb-4"
                id="card-filter"
                onClick={() => changeData('x')}
                style={
                  status.x === true ? { backgroundColor: '#C8C8C8' } : { backgroundColor: 'white' }
                }
              >
                <CCardBody>
                  <Row justify="space-around" align="middle">
                        ...
                        <Row justify="space-around" align="middle">
                          ...
                          <Col span={18} style={{ paddingTop: '10px' }}>
                            ...
                            <h5 style={{ color: '#339900' }}>
                              {data.total_submitted[0]} Mahasiswa
                            </h5>
                          </Col>
                        </Row>
                      </CCardBody>
                        ...
                        <Row justify="space-around" align="middle">
                          ...
                          <Col span={18} style={{ paddingTop: '10px' }}>
                            ...
                            <h5 style={{ color: '#CC0033' }}>
                              {data.total_not_submitted[0]} Mahasiswa
                            </h5>
                          </Col>
                        </Row>
                      </CCardBody>
                          ...
                          dataSource={
                            status.check === false && status.x === false
                              ...
                              ? data.participantList.filter(
                                  (item) => item.status_evaluated[0] === 1,
                                )
                              : data.participantList.filter(
                                  (item) => item.status_evaluated[0] === 0,
                                )
                          }
                          pagination={false}
                          rowKey="id"
                      ...
                      <CCardBody>
                        <Row justify="space-around" align="middle">
                          ...
                          <Col span={18} style={{ paddingTop: '10px' }}>
                            <h6>Sudah Dievaluasi</h6>
                            <h5 style={{ color: '#339900' }}>
                              {data.total_submitted[1]} Mahasiswa
                            </h5>
                          </Col>
                        </Row>
                      </CCardBody>
                      ...
                      <CCardBody>
                        <Row justify="space-around" align="middle">
                          ...
                          <Col span={18} style={{ paddingTop: '10px' }}>
                            <h6>Belum Dievaluasi</h6>
                            <h5 style={{ color: '#CC0033' }}>
                              {data.total_not_submitted[1]} Mahasiswa
                            </h5>
                          </Col>
                        </Row>
                      </CCardBody>
                        ...
                        <Table
                          ...
                          dataSource={
                            status.check === false && status.x === false
                              ...
                              : status.check === true
                              ? data.participantList.filter(
                                  (item) => item.status_evaluated[1] === 1,
                                )
                              : data.participantList.filter(
                                  (item) => item.status_evaluated[1] === 0,
                                )
                          }
                          pagination={false}
                          rowKey="id"
                      ...
                      <CCardBody>
                        <Row justify="space-around" align="middle">
                          ...
                          <Col span={18} style={{ paddingTop: '10px' }}>
                            <h6>Sudah Dievaluasi</h6>
                            <h5 style={{ color: '#339900' }}>
                              {data.total_submitted[2]} Mahasiswa
                            </h5>
                          </Col>
                        </Row>
                      </CCardBody>
                      ...
                      <CCardBody>
                        <Row justify="space-around" align="middle">
                          ...
                          <Col span={18} style={{ paddingTop: '10px' }}>
                            <h6>Belum Dievaluasi</h6>
                            <h5 style={{ color: '#CC0033' }}>
                              {data.total_not_submitted[2]} Mahasiswa
                            </h5>
                          </Col>
                        </Row>
                      </CCardBody>
                        ...
                        <Table
                          ...
                          dataSource={
                            status.check === false && status.x === false
                              ...
                              : status.check === true
                              ? data.participantList.filter(
                                  (item) => item.status_evaluated[2] === 1,
                                )
                              : data.participantList.filter(
                                  (item) => item.status_evaluated[2] === 0,
                                )
                          }
                          pagination={false}
                          rowKey="id"
