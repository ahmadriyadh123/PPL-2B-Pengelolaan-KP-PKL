  ...
  useEffect(() => {
    ...
    if (!id) {
      ...
      const getCV = async () => {
        axios.defaults.withCredentials = true
        await axios
          .get(`${process.env.REACT_APP_API_GATEWAY_URL}participant/cv/detail/${id}`, {
          ...
          .then(function (response1) {
            ...
            axios
              .get(
                `${process.env.REACT_APP_API_GATEWAY_URL}management-content/domicile/${response1.data.data.domicile_id}`,
                {
                  signal: controller.signal,
                },
              )
                ...
                if (parseInt(localStorage.getItem('id_role')) !== 2) {
                  axios
                    .get(
                      ...
                      }management-content/jobscope/get-all/${parseInt(
                        localStorage.getItem('id_prodi'),
                      )}`,
                      {
                        signal: controller.signal,
                      },
                    ...
                    .then(function (response3) {
                      ...
                      axios
                        .get(
                          `${
                            process.env.REACT_APP_API_GATEWAY_URL
                          }management-content/competence/get-all/${parseInt(
                            localStorage.getItem('id_prodi'),
                          )}`,
                          {
                            signal: controller.signal,
                ...
                <CCol sm={12}>
                  ...
                  >
                    ...
                    <Row>
                      <Col span={8}>
                        <b>Jenis Kelamin</b>
                        <Form.Item name="jenKel" style={{ paddingRight: '20px' }}>
                          <Input
                            readOnly
              ...
              <CRow>
                <CCol sm={12}>
                  ...
                  >
                    ...
                    <Form.Item name="defaultValue" initialValue={'Belum mengisi'}>
                      <Input hidden />
                    </Form.Item>
                  </Form>
                </CCol>
                        ...
                        data.experiences.map((item, i) => (
                          <div key={i}>
                            <Row style={{ paddingTop: '10px' }}>
                              <Col span={4}>Nama Mata Kuliah</Col>
                              <Col span={20}>
                                <Form.Item name={`namaMataKuliah-${i}`}>
                                  <Input
                                    readOnly
                                    style={{ cursor: 'not-allowed', background: '#EEEEEE' }}
                                  />
                            ...
                            <Row style={{ paddingTop: '10px' }}>
                              <Col span={4}>Deskripsi</Col>
                              <Col span={20}>
                                <Form.Item name={`description-${i}`}>
                                  <TextArea
                                    rows={4}
                                    readOnly
                                    style={{ cursor: 'not-allowed', background: '#EEEEEE' }}
                            ...
                            <Row style={{ paddingTop: '10px' }}>
                              <Col span={4}>Teknologi dan Alat</Col>
                              <Col span={20}>
                                <Form.Item name={`technology-${i}`}>
                                  <Input
                                    readOnly
                                    style={{ cursor: 'not-allowed', background: '#EEEEEE' }}
                                  />
                            ...
                            <Row style={{ paddingTop: '10px' }}>
                              <Col span={4}>Tugas yang dikerjakan</Col>
                              <Col span={20}>
                                <Form.Item name={`taskName-${i}`}>
                                  <TextArea
                                    rows={4}
                                    readOnly
                                    style={{ cursor: 'not-allowed', background: '#EEEEEE' }}
                            ...
                            <Row style={{ paddingTop: '10px' }}>
                              <Col span={4}>Peran dalam Tim</Col>
                              <Col span={20}>
                                <Form.Item name={`peranTim-${i}`}>
                                  <Input
                                    readOnly
                                    style={{ cursor: 'not-allowed', background: '#EEEEEE' }}
                                  />
                            ...
                            <Row style={{ paddingTop: '10px' }}>
                              <Col span={4}>Pencapaian</Col>
                              <Col span={20}>
                                <Form.Item name={`pencapaian-${i}`}>
                                  <TextArea
                                    rows={4}
                                    readOnly
                                    style={{ cursor: 'not-allowed', background: '#EEEEEE' }}
                            ...
                            <Row style={{ paddingTop: '10px' }}>
                              <Col span={4}>Waktu Pengerjaan</Col>
                              <Col span={20}>
                                <Form.Item name={`waktuPengerjaan-${i}`}>
                                  <Input
                                    readOnly
                                    style={{ cursor: 'not-allowed', background: '#EEEEEE' }}
                                  />
                            ...
                            <Row style={{ paddingTop: '10px' }}>
                              <Col span={4}>Hal yang dipelajari</Col>
                              <Col span={20}>
                                <Form.Item name={`lesson-${i}`}>
                                  <TextArea
                                    rows={4}
                                    readOnly
                                    style={{ cursor: 'not-allowed', background: '#EEEEEE' }}
                  ...
                  >
                    ...
                    {data ? (
                      data.jobscopes.length > 0 ? (
                        data.jobscopes.map((item, i) => (
                          <div key={i}>
                            <Form.Item name={`minatPekerjaan-${i}`} key={i}>
                        ...
                        data.competencies
                          ...
                          .map((item, i) => (
                            <Row style={{ paddingTop: '10px' }} key={i}>
                              ...
                              <Col span={7}>
                                <Form.Item name={`pengetahuanBahasaPemrograman-${i}`}>
                                  <Select disabled style={{ width: '100%' }}>
                      ...
                      data.competencies.filter((item) => item.competence_type === 2).length > 0 ? (
                        data.competencies
                          ...
                          .map((item, i) => (
                            <Row style={{ paddingTop: '10px' }} key={i}>
                              <Col span={14}>
                                <Form.Item name={`database-${i}`} style={{ paddingRight: '20px' }}>
                                  <Select disabled style={{ width: '100%' }}>
                                    {kompetensi &&
                                      kompetensi
                              ...
                              <Col span={7}>
                                <Form.Item name={`pengetahuanDatabase-${i}`}>
                                  <Select disabled style={{ width: '100%' }}>
                                    {pengetahuan.map((item, i) => (
                                      <Select.Option key={i} value={item.id}>
                                        {item.name}
                      ...
                      data.competencies.filter((item) => item.competence_type === 3).length > 0 ? (
                        data.competencies
                          ...
                          .map((item, i) => (
                            <Row style={{ paddingTop: '10px' }} key={i}>
                              <Col span={14}>
                                <Form.Item name={`framework-${i}`} style={{ paddingRight: '20px' }}>
                                  <Select disabled style={{ width: '100%' }}>
                                    {kompetensi &&
                                      kompetensi
                              ...
                              <Col span={7}>
                                <Form.Item name={`pengetahuanFramework-${i}`}>
                                  <Select disabled style={{ width: '100%' }}>
                                    {pengetahuan.map((item, i) => (
                                      <Select.Option key={i} value={item.id}>
                                        {item.name}
                      ...
                      data.competencies.filter((item) => item.competence_type === 4).length > 0 ? (
                        data.competencies
                          ...
                          .map((item, i) => (
                            <Row style={{ paddingTop: '10px' }} key={i}>
                              <Col span={14}>
                                <Form.Item name={`tools-${i}`} style={{ paddingRight: '20px' }}>
                                  <Select disabled style={{ width: '100%' }}>
                                    {kompetensi &&
                                      kompetensi
                              ...
                              <Col span={7}>
                                <Form.Item name={`pengetahuanTools-${i}`}>
                                  <Select disabled style={{ width: '100%' }}>
                                    {pengetahuan.map((item, i) => (
                                      <Select.Option key={i} value={item.id}>
                                        {item.name}
                      ...
                      data.competencies.filter((item) => item.competence_type === 5).length > 0 ? (
                        data.competencies
                          ...
                          .map((item, i) => (
                            <Row style={{ paddingTop: '10px' }} key={i}>
                              <Col span={14}>
                                <Form.Item name={`modelling-${i}`} style={{ paddingRight: '20px' }}>
                                  <Select disabled style={{ width: '100%' }}>
                                    {kompetensi &&
                                      kompetensi
                              ...
                              <Col span={7}>
                                <Form.Item name={`pengetahuanModelling-${i}`}>
                                  <Select disabled style={{ width: '100%' }}>
                                    {pengetahuan.map((item, i) => (
                                      <Select.Option key={i} value={item.id}>
                                        {item.name}
                        ...
                        data.competencies
                          ...
                          .map((item, i) => (
                            <Row style={{ paddingTop: '10px' }} key={i}>
                              ...
                              <Col span={7}>
                                <Form.Item name={`pengetahuanBahasaKomunikasi-${i}`}>
                                  <Select disabled style={{ width: '100%' }}>
                                    {pengetahuan.map((item, i) => (
                                      <Select.Option key={i} value={item.id}>
                                        {item.name}
