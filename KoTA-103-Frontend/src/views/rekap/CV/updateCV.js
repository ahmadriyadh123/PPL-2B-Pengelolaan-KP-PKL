...
const UpdateCV = () => {
        ...
        .post(`${process.env.REACT_APP_API_GATEWAY_URL}management-content/jobscope/create`, {
          ...
          prodi_id:
            parseInt(localStorage.getItem('id_role')) !== 2
              ? parseInt(localStorage.getItem('id_prodi'))
              : 0,
        })
        .then((response) => {
          refreshData(index)
  ...
  const onFinish = async (index, step) => {
    if (prev === true) {
      ...
      if (save === true) {
        ...
        await axios
          .put(`${process.env.REACT_APP_API_GATEWAY_URL}participant/cv/update/${id}`, {
            nickname: data.nickname,
            address: data.address,
            email: data.email,
            religion: data.religion,
            ...
            educations:
              step >= 1
                ? jenjangPendidikan
                : data.educations === jenjangPendidikan
                ? jenjangPendidikan
                  ? jenjangPendidikan
                  : null
                : data.educations
            ...
            experiences:
              step >= 2
                ? pengalamanPengerjaanTugas
                : data.experiences === pengalamanPengerjaanTugas
                ? pengalamanPengerjaanTugas
                  ? pengalamanPengerjaanTugas
                  : null
                : data.experiences
            ...
            organizations:
              step >= 1
                ...
                : data.organizations === pengalamanBerorganisasi
                ? pengalamanBerorganisasi
                  ? pengalamanBerorganisasi
                  : null
                : data.organizations
            ...
            seminars:
              step >= 1
                ? seminarTutorialCourse
                : data.seminars === seminarTutorialCourse
                ? seminarTutorialCourse
                  ? seminarTutorialCourse
                  : null
                : data.seminars
  ...
  const refreshData = (index) => {
    axios
      .get(
        `${process.env.REACT_APP_API_GATEWAY_URL}management-content/competence/get-all/${
          parseInt(localStorage.getItem('id_role')) !== 2
            ? parseInt(localStorage.getItem('id_prodi'))
            : 0
        }`,
      ...
      .then((result) => {
        ...
        axios
          .get(
            `${process.env.REACT_APP_API_GATEWAY_URL}management-content/jobscope/get-all/${
              parseInt(localStorage.getItem('id_role')) !== 2
                ? parseInt(localStorage.getItem('id_prodi'))
                : 0
            }`,
    ...
    const getCV = async () => {
      ...
      try {
        const response = await axios.get(
          `${process.env.REACT_APP_API_GATEWAY_URL}participant/cv/detail/${id}`,
          {
        ...
        const domicileResponse = await axios.get(
          `${process.env.REACT_APP_API_GATEWAY_URL}management-content/domicile/${response.data.data.domicile_id}`,
          {
            signal: controller.signal,
          },
        )
        setRegion(domicileResponse.data.data)

        const jobscopeResponse = await axios.get(
          `${process.env.REACT_APP_API_GATEWAY_URL}management-content/jobscope/get-all/${
            parseInt(localStorage.getItem('id_role')) !== 2
              ? parseInt(localStorage.getItem('id_prodi'))
              : 0
        ...
        setJobscope(jobscopeResponse.data.data)

        const kompetensiResponse = await axios.get(
          `${process.env.REACT_APP_API_GATEWAY_URL}management-content/competence/get-all/${
            parseInt(localStorage.getItem('id_role')) !== 2
              ? parseInt(localStorage.getItem('id_prodi'))
              : 0
        ...
        setKompetensi(kompetensiResponse.data.data)
  ...
  const onChangeKompetensi = () => {
    let data = []
    form1.getFieldValue('bahasaPemrograman') &&
      form1.getFieldValue('bahasaPemrograman').map((item) => {
        return item && data.push(item.competence_id)
      })
    form1.getFieldValue('database') &&
      form1.getFieldValue('database').map((item) => {
        return item && data.push(item.competence_id)
      })
    form1.getFieldValue('framework') &&
      form1.getFieldValue('framework').map((item) => {
        return item && data.push(item.competence_id)
      })
    form1.getFieldValue('modelling') &&
      form1.getFieldValue('modelling').map((item) => {
        return item && data.push(item.competence_id)
      })
    form1.getFieldValue('tools') &&
      form1.getFieldValue('tools').map((item) => {
        return item && data.push(item.competence_id)
      })
    form1.getFieldValue('bahasaKomunikasi') &&
      form1.getFieldValue('bahasaKomunikasi').map((item) => {
        return item && data.push(item.competence_id)
      })
    setChooseKompetensi(data)
  }
        ...
        <CRow>
          <CCol sm={12}>
            ...
            >
              ...
              <b>Email</b>
              <Form.Item name="email" rules={[{ type: 'email', message: 'Format email salah!' }]}>
                <Input
                  onChange={(e) => {
                    setData((pre) => {
              ...
              <b>Kewarganegaraan</b>
              <Form.Item name="kewarganegaraan">
                <Input
                  onChange={(e) => {
                    setData((pre) => {
              ...
              <Row>
                ...
                <Col span={8}>
                  <b>Status</b>
                  <Form.Item name="status" style={{ paddingRight: '20px' }}>
                    <Radio.Group>
                      <Radio
                        value={true}
                        onChange={(e) => {
              ...
              <Row>
                <Col span={8}>
                  <b>Agama</b>
                  <Form.Item name="religion" style={{ paddingRight: '20px' }}>
                ...
                <Col span={8}>
                  <b>Tempat Lahir</b>
                  <Form.Item name="tempatLahir" style={{ paddingRight: '20px' }}>
                    <Input
                      onChange={(e) => {
                        setData((pre) => {
              ...
              <Form.List
                ...
                initialValue={
                  ...
                  data.educations.map((item) => {
                    return {
                      yearPendidikan: [
                        moment(item.start_year.toString()),
                        moment(item.end_year.toString()),
                      ],
                      institution_name: item.institution_name,
                    }
                  })
                      ...
                      <Row key={key} style={{ paddingTop: '10px' }}>
                        ...
                        <Col span={9}>
                          <Form.Item
                            ...
                            rules={[
                              { required: true, message: 'Nama kejuaraan tidak boleh kosong!' },
                            ]}
                            style={{ paddingRight: '20px' }}
                          >
                            <Input />
        ...
        <CRow>
          <CCol sm={12}>
            ...
            >
              ...
              <Form.List
                name="pengalamanPengerjaanTugas"
                initialValue={
                  data &&
                  data.experiences &&
                        ...
                        <Row style={{ paddingTop: '10px' }}>
                          ...
                          <Col span={20}>
                            <Form.Item
                              ...
                              rules={[
                                { required: true, message: 'Nama mata kuliah tidak boleh kosong!' },
                              ]}
                            >
                              <Input />
                            </Form.Item>
                          ...
                          <Col span={20}>
                            <Form.Item
                              ...
                              rules={[
                                {
                                  required: true,
                                  message: 'Teknologi dan alat tidak boleh kosong!',
                                },
                              ]}
                            >
                              <Input />
                        ...
                        <Row style={{ paddingTop: '10px' }}>
                          ...
                          <Col span={20}>
                            <Form.Item
                              ...
                              rules={[
                                { required: true, message: 'Nama tugas tidak boleh kosong!' },
                              ]}
                            >
                              <TextArea rows={4} />
                            </Form.Item>
                        ...
                        <Row style={{ paddingTop: '10px' }}>
                          ...
                          <Col span={20}>
                            <Form.Item
                              ...
                              rules={[
                                { required: true, message: 'Peran dalam tim tidak boleh kosong!' },
                              ]}
                            >
                              <Input />
                            </Form.Item>
                        ...
                        <Row style={{ paddingTop: '10px' }}>
                          ...
                          <Col span={20}>
                            <Form.Item
                              ...
                              rules={[
                                { required: true, message: 'Pencapaian tidak boleh kosong!' },
                              ]}
                            >
                              <TextArea rows={4} />
                            </Form.Item>
                        ...
                        <Row style={{ paddingTop: '10px' }}>
                          ...
                          <Col span={20}>
                            <Form.Item
                              ...
                              rules={[
                                { required: true, message: 'Waktu pengerjaan tidak boleh kosong!' },
                              ]}
                            >
                              <Input />
                            </Form.Item>
                              ...
                              dropdownRender={(menu) => (
                                <>
                                  <Space align="center" style={{ padding: '0 8px 4px' }}>
                                    <Typography.Link
                                      onClick={() => showModalCreate('Minat Pekerjaan')}
                              ...
                              {jobscope &&
                                jobscope.map((item, i) => (
                                  <Select.Option
                                    key={i}
                                    value={item.id}
                                    disabled={chooseMinat.includes(item.id)}
                                  >
                                    {item.name}
                                  </Select.Option>
                                ))}
            ...
            >
              ...
              <Form.List
                ...
                initialValue={
                  data &&
                  data.competencies &&
                  data.competencies.filter((item) => item.competence_type === 1).length > 0 &&
                  data.competencies
                      ...
                      <Row key={key} style={{ paddingTop: '10px' }}>
                        ...
                        <Col span={13}>
                          <Form.Item
                            ...
                            rules={[
                              { required: true, message: 'Bahasa pemrograman tidak boleh kosong!' },
                            ]}
                            style={{ paddingRight: '20px' }}
                          >
                            <Select
                                ...
                                kompetensi
                                  ...
                                  .map((item, i) => (
                                    <Select.Option
                                      key={i}
                                      value={item.id}
                                      disabled={chooseKompetensi.includes(item.id)}
                                    >
                                      {item.name}
                                    </Select.Option>
                                  ))}
              ...
              <Form.List
                ...
                initialValue={
                  data &&
                  data.competencies &&
                  data.competencies.filter((item) => item.competence_type === 2).length > 0 &&
                  data.competencies
              ...
              <Form.List
                ...
                initialValue={
                  data &&
                  data.competencies &&
                  data.competencies.filter((item) => item.competence_type === 3).length > 0 &&
                  data.competencies
              ...
              <Form.List
                ...
                initialValue={
                  data &&
                  data.competencies &&
                  data.competencies.filter((item) => item.competence_type === 4).length > 0 &&
                  data.competencies
              ...
              <Form.List
                ...
                initialValue={
                  data &&
                  data.competencies &&
                  data.competencies.filter((item) => item.competence_type === 5).length > 0 &&
                  data.competencies
              ...
              <Form.List
                ...
                initialValue={
                  data &&
                  data.competencies &&
                  data.competencies.filter((item) => item.competence_type === 6).length > 0 &&
                  data.competencies
                      ...
                      <Row key={key} style={{ paddingTop: '10px' }}>
                        ...
                        <Col span={13}>
                          <Form.Item
                            ...
                            fieldKey={[key, 'id_competence']}
                            rules={[
                              { required: true, message: 'Bahasa komunikasi tidak boleh kosong!' },
                            ]}
                            style={{ paddingRight: '20px' }}
                          >
                            <Select
