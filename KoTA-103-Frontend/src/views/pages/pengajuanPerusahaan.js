...
import { CCard, CCardBody, CCardGroup, CCol, CContainer, CCardHeader, CRow } from '@coreui/react'
...
const PengajuanPerusahaan = () => {
    ...
    async function getDataKriteriaPerusahaan() {
      await axios
        ...
        .then((result) => {
          ...
          axios
            .get(`${process.env.REACT_APP_API_GATEWAY_URL}management-content/form-submit-time/1`, {
              signal: controller.signal,
            })
            .then((result) => {
  ...
  const handleOkCreate = async (index) => {
    ...
    let proposer = []
    let advantages = []
    form.getFieldValue('namaPengusul') &&
      form.getFieldValue('namaPengusul').map((item) => {
        return proposer.push(item.nim ? `${item.namaPengusul} (${item.nim})` : item.namaPengusul)
      })
    form.getFieldValue('keunggulanPerusahaan') &&
      form.getFieldValue('keunggulanPerusahaan').map((item) => {
    ...
    await axios
      .post(`${process.env.REACT_APP_API_GATEWAY_URL}company/submission/create`, {
        proposer: data,
        ...
        since_year:
          form.getFieldValue('berdiriTahun') && form.getFieldValue('berdiriTahun')._d.getFullYear(),
                ...
                <CCardGroup>
                  <CCard>
                    <CCardHeader style={{ paddingLeft: '20px' }}>
                      <h5>
                        <b>Formulir Pengajuan Perusahaan</b>
                      </h5>
                    </CCardHeader>
                        ...
                        <CCol sm={12}>
                          ...
                          >
                              ...
                              {(fields, { add, remove }) => (
                                <>
                                  {fields.map(({ key, name, ...restField }) => (
                                    <Row key={key}>
                                      <Col span={2}>
                                        Nama Pengusul<span style={{ color: 'red' }}> *</span>
                                      </Col>
                                      <Col span={10} style={{ paddingRight: '20px' }}>
                                        <Form.Item
                                          ...
                                          rules={[
                                            {
                                              required: true,
                                              message: 'Nama pengusul tidak boleh kosong!',
                                            },
                                          ]}
                                        >
                                          <Input />
                            ...
                            <Row>
                              ...
                              <Col span={6}>
                                Diajukan untuk Program Studi<span style={{ color: 'red' }}> *</span>
                              </Col>
                              <Col span={7}>
                                <Form.Item
                                  name="prodi"
                                  rules={[
                                    {
                                      required: true,
                                      message: 'Penerima program studi tidak boleh kosong!',
                                    },
                                  ]}
                                >
                                  <Select>
                            ...
                            <Row>
                              ...
                              <Col span={7}>
                                <Form.Item
                                  ...
                                  rules={[
                                    {
                                      message: 'Format jumlah pegawai hanya angka!',
                                      pattern: /^\d+$/,
                                    },
                                  ]}
                                >
                            ...
                            <Row>
                              ...
                              <Col span={8} style={{ paddingRight: '20px' }}>
                                <Form.Item
                                  ...
                                  rules={[
                                    {
                                      message: 'Format nomor telepon hanya angka!',
                                      pattern: /^\d+$/,
                                    },
                                    {
                                      required: true,
                              ...
                              <Col span={7}>
                                <Form.Item
                                  name="email"
                                  rules={[
                                    { message: 'Format email salah!', type: 'email' },
                                    {
                                      required: true,
                                      message: 'Email perusahaan tidak boleh kosong!',
                                    },
                                  ]}
                                >
                                  <Input />
                            ...
                            <Row>
                              <Col span={5}>
                                Nama Narahubung<span style={{ color: 'red' }}> *</span>
                              </Col>
                              <Col span={7} style={{ paddingRight: '20px' }}>
                                <Form.Item
                                  ...
                                  rules={[
                                    {
                                      required: true,
                                      message: 'Nama narahubung tidak boleh kosong!',
                                    },
                                  ]}
                                >
                                  <Input />
                              ...
                              <Col span={5}>
                                Jabatan Narahubung<span style={{ color: 'red' }}> *</span>
                              </Col>
                              <Col span={7}>
                                <Form.Item
                                  name="jabatanCP"
                            ...
                            <Row>
                              <Col span={5}>
                                No. HP Narahubung<span style={{ color: 'red' }}> *</span>
                              </Col>
                              <Col span={7} style={{ paddingRight: '20px' }}>
                                <Form.Item
                                  name="nohpCP"
                                  rules={[
                                    {
                                      required: true,
                                      message: 'Nomor hp narahubung tidak boleh kosong!',
                                    },
                                    {
                                      message: 'Format nomor telepon hanya angka!',
                                      pattern: /^\d+$/,
                              ...
                              <Col span={5}>
                                Email Narahubung<span style={{ color: 'red' }}> *</span>
                              </Col>
                              <Col span={7}>
                                <Form.Item
                                  name="emailCP"
                            ...
                            <b>
                              Kriteria Perusahaan<span style={{ color: 'red' }}> *</span>
                            </b>
                            <hr></hr>
                            <CCard>
                              <CCardBody>
                                <Form.Item
                                  ...
                                  rules={[
                                    {
                                      required: true,
                                      message: 'Minimal pilih salah satu kriteria!',
                                    },
                                  ]}
                                >
                                  <Checkbox.Group>
