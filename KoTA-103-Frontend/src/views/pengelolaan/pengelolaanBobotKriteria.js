...
const PengelolaanBobotKriteria = () => {
  ...
  const refreshData = (index) => {
    axios.get(`${process.env.REACT_APP_API_GATEWAY_URL}mapping/criteria`).then((result) => {
      setBobot({
  ...
  useEffect(() => {
    ...
    async function getDataBobot() {
      await axios
        .get(`${process.env.REACT_APP_API_GATEWAY_URL}mapping/criteria`, {
  ...
  const onFinish = async (index) => {
    if (countBobot() === 100) {
      enterLoading(index)
      await axios
        .put(`${process.env.REACT_APP_API_GATEWAY_URL}mapping/criteria/update`, [
          {
            id: 1,
  ...
  const countBobot = () => {
    return (
      parseInt(isKosong(bobot.bobotMinat)) +
      parseInt(isKosong(bobot.bobotDomisili)) +
      parseInt(isKosong(bobot.bobotPrioritas)) +
      parseInt(isKosong(bobot.bobotBahasaPemrograman)) +
      parseInt(isKosong(bobot.bobotDatabase)) +
      parseInt(isKosong(bobot.bobotFramework)) +
      parseInt(isKosong(bobot.bobotTools)) +
      parseInt(isKosong(bobot.bobotModelling)) +
      parseInt(isKosong(bobot.bobotBahasaKomunikasi))
    )
  }
  return isLoading ? (
      ...
      <CCard>
        <CCardHeader style={{ paddingLeft: '20px' }}>
          <Row align="middle">
            <Col>
              <h5>
                <b>Pengelolaan Bobot Kriteria Perangkingan &nbsp;</b>
              </h5>
            </Col>
            <Col>
              {countBobot() !== 100 ? (
                ...
                <Row style={{ paddingLeft: '30px' }}>
                  <Col span={8} style={{ paddingRight: '30px' }}>
                    ...
                    <Form.Item
                      name="minatPekerjaan"
                      rules={[
                        { message: 'Format bobot minat pekerjaan hanya angka!', pattern: /^\d+$/ },
                  ...
                  <Col span={8} style={{ paddingRight: '30px' }}>
                    ...
                    <Form.Item
                      name="domisili"
                      rules={[
                        { message: 'Format bobot domisili hanya angka!', pattern: /^\d+$/ },
                  ...
                  <Col span={8} style={{ paddingRight: '30px' }}>
                    ...
                    <Form.Item
                      ...
                      rules={[
                        {
                          message: 'Format bobot prioritas perusahaan hanya angka!',
                          pattern: /^\d+$/,
                        },
                        {
                          required: true,
                          message: 'Bobot prioritas perusahaan tidak boleh kosong!',
                        },
                      ]}
                    >
                      <Input
                ...
                <Row style={{ paddingLeft: '30px' }}>
                  <Col span={8} style={{ paddingRight: '30px' }}>
                    ...
                    <Form.Item
                      ...
                      rules={[
                        {
                          message: 'Format bobot bahasa pemrograman hanya angka!',
                          pattern: /^\d+$/,
                        },
                  ...
                  <Col span={8} style={{ paddingRight: '30px' }}>
                    ...
                    <Form.Item
                      name="database"
                      rules={[
                        { message: 'Format bobot database hanya angka!', pattern: /^\d+$/ },
                  ...
                  <Col span={8} style={{ paddingRight: '30px' }}>
                    ...
                    <Form.Item
                      name="framework"
                      rules={[
                        { message: 'Format bobot framework hanya angka!', pattern: /^\d+$/ },
                ...
                <Row style={{ paddingLeft: '30px' }}>
                  <Col span={8} style={{ paddingRight: '30px' }}>
                    ...
                    <Form.Item
                      name="tools"
                      rules={[
                        { message: 'Format bobot tools hanya angka!', pattern: /^\d+$/ },
                  ...
                  <Col span={8} style={{ paddingRight: '30px' }}>
                    ...
                    <Form.Item
                      name="modelling"
                      rules={[
                        { message: 'Format bobot modelling hanya angka!', pattern: /^\d+$/ },
                  ...
                  <Col span={8} style={{ paddingRight: '30px' }}>
                    ...
                    <Form.Item
                      ...
                      rules={[
                        {
                          message: 'Format bobot bahasa komunikasi hanya angka!',
                          pattern: /^\d+$/,
                        },
