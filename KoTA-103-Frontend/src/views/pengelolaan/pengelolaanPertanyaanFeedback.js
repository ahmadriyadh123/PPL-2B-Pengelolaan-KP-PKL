...
const PengelolaanPertanyaanFeedback = () => {
  ...
  const refreshData = (index) => {
    axios
      .get(
        ...
        }management-content/feedback-question/get-all/${localStorage.getItem('id_prodi')}`,
      )
      .then((result) => {
  ...
  const handleOkCreate = async (index) => {
    ...
    await axios
      .post(`${process.env.REACT_APP_API_GATEWAY_URL}management-content/feedback-question/create`, {
  ...
  const handleOkEdit = async (index) => {
    ...
    await axios
      .put(
        `${process.env.REACT_APP_API_GATEWAY_URL}management-content/feedback-question/update/${choose.id}`,
        {
  ...
  const handleOkDelete = async (record, index) => {
    ...
    await axios
      .delete(
        `${process.env.REACT_APP_API_GATEWAY_URL}management-content/feedback-question/delete/${record.id}`,
      )
      .then((response) => {
        refreshData(index)
        notification.success({
  ...
  return isLoading ? (
    ...
    <>
              ...
              <Table
                ...
                dataSource={
                  localStorage.getItem('id_prodi') === '0'
                    ? dataPertanyaanFeedbackD3
                    : dataPertanyaanFeedbackD4
                }
                rowKey="id"
                bordered
              />
      ...
      <Modal
        title={`Buat Pertanyaan Feedback`}
      ...
      >
        ...
        >
          <b>
            Pertanyaan Feedback<span style={{ color: 'red' }}> *</span>
          </b>
          <Form.Item
            name="namaPertanyaan"
      ...
      <Modal
        title="Ubah Data Pertanyaan Feedback"
