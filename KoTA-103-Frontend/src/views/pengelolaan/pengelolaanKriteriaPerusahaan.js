...
const PengelolaanKriteriaPerusahaan = () => {
  ...
  const handleOkCreate = async (index) => {
    enterLoading(index)
    await axios
      .post(`${process.env.REACT_APP_API_GATEWAY_URL}company/criteria/create`, {
  ...
  const handleOkEdit = async (index) => {
    enterLoading(index)
    await axios
      .put(`${process.env.REACT_APP_API_GATEWAY_URL}company/criteria/update/${choose.id}`, {
  ...
  const handleOkDelete = async (record, index) => {
    enterLoading(index)
    await axios
      .delete(`${process.env.REACT_APP_API_GATEWAY_URL}company/criteria/delete/${record.id}`)
      .then((response) => {
        refreshData(index)
        notification.success({
  ...
  return isLoading ? (
    ...
    <>
      ...
      <Modal
        title="Buat Kriteria Perusahaan"
      ...
      >
        ...
        >
          <b>
            Nama Kriteria Perusahaan<span style={{ color: 'red' }}> *</span>
          </b>
          <Form.Item
            name="criteriaName"
      ...
      <Modal
        title="Ubah Data Kriteria Perusahaan"
