...
const PengelolaanAspekPenilaianEvaluasi = () => {
  ...
  const refreshData = (index) => {
    axios
      .get(`${process.env.REACT_APP_API_GATEWAY_URL}management-content/assessment-aspect`)
      .then((result) => {
  ...
  const handleOkCreate = async (index) => {
    ...
    await axios
      .post(`${process.env.REACT_APP_API_GATEWAY_URL}management-content/assessment-aspect/create`, {
  ...
  const handleOkEdit = async (index) => {
    ...
    await axios
      .put(
        `${process.env.REACT_APP_API_GATEWAY_URL}management-content/assessment-aspect/update/${choose.id}`,
        {
  ...
  const handleOkDelete = async (record, index) => {
    ...
    await axios
      .delete(
        `${process.env.REACT_APP_API_GATEWAY_URL}management-content/assessment-aspect/delete/${record.id}`,
      )
      .then((response) => {
        refreshData(index)
        notification.success({
  ...
  return isLoading ? (
    ...
    <>
              ...
              <CRow>
                <CCol sm={12}>
                  ...
                  <Table
                    ...
                    columns={columns}
                    dataSource={dataAspekPenilaianD3}
                    rowKey="id"
                    bordered
                  />
                </CCol>
                      ...
                      <CRow>
                        <CCol sm={12}>
                          ...
                          <Table
                            scroll={{ x: 'max-content' }}
                            columns={columns}
                            dataSource={dataAspekPenilaianD4.evaluation1}
                            rowKey="id"
                            bordered
                          />
                        </CCol>
                      ...
                      <CRow>
                        <CCol sm={12}>
                          ...
                          <Table
                            scroll={{ x: 'max-content' }}
                            columns={columns}
                            dataSource={dataAspekPenilaianD4.evaluation2}
                            rowKey="id"
                            bordered
                          />
                        </CCol>
                      ...
                      <CRow>
                        <CCol sm={12}>
                          ...
                          <Table
                            scroll={{ x: 'max-content' }}
                            columns={columns}
                            dataSource={dataAspekPenilaianD4.evaluation3}
                            rowKey="id"
                            bordered
                          />
                        </CCol>
      ...
      <Modal
        title={`Buat Aspek Penilaian Evaluasi ${evaluasi}`}
      ...
      >
        ...
        >
          <b>
            Nama Aspek Penilaian<span style={{ color: 'red' }}> *</span>
          </b>
          <Form.Item
            name="namaAspek"
      ...
      <Modal
        title="Ubah Data Aspek Penilaian"
