...
const PengelolaanKompetensi = () => {
  ...
  const refreshData = (activeKey = 1) => {
    ...
    axios
      ...
      .then((result) => setDataKompetensi(result.data.data))
    axios
      .get(
  ...
  const handleOkEdit = async (kompetensi, index) => {
    ...
    if (kompetensi === 'Cakupan Pekerjaan') {
      await axios
        .put(
          `${process.env.REACT_APP_API_GATEWAY_URL}management-content/jobscope/update/${choose.id}`,
          {
            name: choose.name,
          },
        )
      ...
      await axios
        .put(
          `${process.env.REACT_APP_API_GATEWAY_URL}management-content/competence/update/${choose.id}`,
          {
            name: choose.name,
  ...
  const handleOkDelete = async (kompetensi, choose, index) => {
    ...
    if (kompetensi === 'Cakupan Pekerjaan') {
      await axios
        .delete(
          `${process.env.REACT_APP_API_GATEWAY_URL}management-content/jobscope/delete/${choose.id}`,
          {},
        )
        .then((response) => {
          refreshData()
      ...
      await axios
        .delete(
          `${process.env.REACT_APP_API_GATEWAY_URL}management-content/competence/delete/${choose.id}`,
          {},
        )
        .then((response) => {
          refreshData()
  ...
  const onChange = (activeKey) => {
    ...
    if (activeKey === '0') {
      ...
      localStorage.getItem('id_role') === '1'
        ? (items[1].title = 'Nama Minat Pekerjaan')
        : (items[1].title = 'Nama Cakupan Pekerjaan')
    }
    setColumns(items)
  }
                    ...
                    {tipeKompetensi.map((item, i) => (
                      ...
                      >
                        ...
                        <Table
                          ...
                          columns={getColumns()}
                          dataSource={
                            item.description === 'Cakupan Pekerjaan'
                              ? dataJobscope
